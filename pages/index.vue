<template>
	<div class="w-full h-full p-x4 flex flex-col gap-x4 items-center justify-center">
		<UiLogo 
			width="80%"
			max-width="280px"
		/>
...
const subscribeUrl = computed(() => {
	return `https://docs.google.com/forms/d/e/${ config.public.google_form_id }/viewform`
})
</script>
